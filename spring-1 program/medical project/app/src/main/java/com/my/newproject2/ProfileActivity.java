	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				var = new HashMap<>();
				var.put(" fullname", edittext1.getText().toString());
				var.put("age", edittext2.getText().toString());
				var.put("address ", edittext3.getText().toString());
				var.put("password ", edittext4.getText().toString());
				var.put("confirmpassword", edittext5.getText().toString());
