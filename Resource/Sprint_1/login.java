...
public class MainActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		login.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				if (mailedit.getText().toString().equals("") || pw.getText().toString().equals("")) {
					SketchwareUtil.showMessage(getApplicationContext(), "empty");
				}
				else {
					aut.signInWithEmailAndPassword(mailedit.getText().toString(), pw.getText().toString()).addOnCompleteListener(MainActivity.this, _aut_sign_in_listener);
				}
			}
		});
